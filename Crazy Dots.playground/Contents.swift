...
if let dir = fileManager.urls(for: .documentDirectory, in: .userDomainMask).first {
    let fileURL = dir.appendingPathComponent("/Users/viorelharabaru/Documents/WORKSTAGE/# PROGRAMMING/iOS DEVELOPMENT/iOS Apps & Swift Projects/Crazy Dots/test.scap")
    do {
